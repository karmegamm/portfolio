...
const About = () => {
  ...
  return <section id='about' className='section relative' ref={ref}>
    <div class="wrapper">
    <div class="box">
      <div></div>
      <div></div>
      ...
      className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen' >
        ...
        <motion.div 
           ...
           viewport={{once:true,amount:0.3}}
            ...
            <h3 className='h3 text-white/95  mb-12 leading-8 font-secondary  font-medium uppercase text-[30px] '>I'm the ♨️ Spark that Ignites Connections Everywhere. </h3>
